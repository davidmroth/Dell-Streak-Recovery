...
ifeq ($(TARGET_CUSTOM_RECOVERY_UI_LIB),)
  LOCAL_SRC_FILES += default_recovery_ui.c
else
  LOCAL_STATIC_LIBRARIES += $(TARGET_CUSTOM_RECOVERY_UI_LIB)
endif
...
RECOVERY_LINKS := amend busybox flash_image dump_image mkyaffs2image unyaffs erase_image nandroid reboot logcat setprop getprop
